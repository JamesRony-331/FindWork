...
export const homePreviewMeta = { title: '就业数据概览', updatedAt: '数据更新至 2026 年 8 月', status: '数据正常' }
export const homeTrend = [
  { month: '3月', value: 36 }, { month: '4月', value: 48 }, { month: '5月', value: 44 },
  { month: '6月', value: 63 }, { month: '7月', value: 58 }, { month: '8月', value: 82 },
]
...
export const homeFeatureLinks = [
  { icon: 'search', title: '岗位数据查询', description: '按岗位、城市、学历和薪资快速筛选招聘信息', path: '/user/jobs' },
  { icon: 'salary', title: '薪资水平分析', description: '对比岗位类别、经验与学历对应的薪资差异', path: '/user/analysis/salary' },
  { icon: 'location', title: '城市就业分析', description: '发现重点城市的岗位数量与就业机会分布', path: '/user/analysis/city' },
  { icon: 'chat', title: 'AI 就业助手', description: '结合演示数据获取求职方向与能力提升建议', path: '/user/ai-chat' },
]
export function getHomeActions() { return [{ label: '查看系统展示', path: '/showcase', primary: true, featured: true }, { label: '进入数据看板', path: '/user/dashboard', primary: false }, { label: '查询招聘岗位', path: '/user/jobs', primary: false }] }
